...
export const sendWelcomeEmail = async ({ to, name }: WelcomeEmailInput): Promise<void> => {
  ...
  console.log(`[Email] Attempting to send welcome email to: ${to} via Brevo API...`);
                      ...
                      <tr>
                        <td style="padding:32px;">
                          ...
                          <div style="text-align:center;margin-top:32px;">
                            <a href="${appUrl}" style="display:inline-block;background:#3b82f6;color:#ffffff;text-decoration:none;font-weight:700;font-size:16px;padding:16px 32px;border-radius:12px;box-shadow:0 10px 15px -3px rgba(59, 130, 246, 0.5);">Khám Phá Nền Tảng Ngay</a>
                          </div>
